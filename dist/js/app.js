...
let regionsName = []; //https://war-service-live.foxholeservices.com/api/worldconquest/maps
regionsDynamicData = []; // [{regionName : https://war-service-live.foxholeservices.com/api/worldconquest/maps/' + regionName + '/dynamic/public}, ...]
